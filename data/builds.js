...
window.BUILD_IMAGE_EXTRACTS = {
  ...
  travelerCryo: { buildAvailable: true, character: { level: 90 }, weapon: { name: "Sabre da Ponta Estelar", level: 90, refinement: 3, rarity: 4 }, stats: { "Vida Máxima": 19915, ATQ: 2454, DEF: 1015, "Proficiência Elemental": 98, "Taxa Crítica": 51.3, "Dano Crítico": 172.8, "Recarga de Energia": 106.5 }, artifactSets: [{ name: "Desencantamento na Sombra Profunda", count: 4 }] },
...
var reviewedBuildValues = {
  ...
  travelerCryo: { character: { level: 90, constellation: 0 }, talents: { normal: 1, skill: 1, burst: 2 }, metrics: { cv: 149.2 } },
